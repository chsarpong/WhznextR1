<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage7.aspx.cs" Inherits="stgWifi8.MusicPage7" %>
...
<%--                <img src="Images/searchicon.png" alt="" />--%>
    ...
    <%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Hot 108 Jamz" CssClass="lbradio"></asp:Label>
     <asp:Button ID="Button1" runat="server" Text="Share momment with community" 
         Height="25px" CssClass="comment"></asp:Button>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
   ...
   <div id="fb-root"></div> <script>                                (function (d, s, id) { var js, fjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = "//connect.facebook.net/en_US/all.js#xfbml=1"; fjs.parentNode.insertBefore(js, fjs); } (document, 'script', 'facebook-jssdk'));</script>
    <div class="fb-post" data-href="https://www.facebook.com/STGWiFiRadio/photos/a.485251808232356.1073741827.484846584939545/597496477007888/?type=1" data-width="396"><div class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/STGWiFiRadio/photos/a.485251808232356.1073741827.484846584939545/597496477007888/?type=1">Post</a> by <a href="https://www.facebook.com/STGWiFiRadio">STG WiFi</a>.</div></div>
   </div>
