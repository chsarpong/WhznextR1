<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Funny.aspx.cs" Inherits="stgWifi8.Funny.Funny" %>
...
<script>    (function (d, s, id) {
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Funny" CssClass="hh"></asp:Label>
