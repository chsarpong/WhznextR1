<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HealthyLiving.aspx.cs" Inherits="stgWifi8.HealthyLiving.HealthyLiving" %>
...
<script>    (function (d, s, id) {
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Health Living" CssClass="hh"></asp:Label>
...
<%-- <img src="Images/Nokia-Lumia920NFC.jpg" alt="" class="advert" />--%>
 ...
 <a href="ProductFound.aspx">Humor</a><br />
 <a href="ProductFound.aspx">Jokes</a><br />
 <a href="ProductFound.aspx">Comic</a><br />
