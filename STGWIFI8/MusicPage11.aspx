<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage11.aspx.cs" Inherits="stgWifi8.MusicPage11" %>
...
<%--                <img src="Images/searchicon.png" alt="" />--%>
  ...
  <br />
    <%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Flow Radio" CssClass="lbradio"></asp:Label>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
