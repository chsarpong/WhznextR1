<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyBlogSignIn.aspx.cs" Inherits="stgWifi8.MyBlogSignIn" %>
   ...
   <div class="container2">
    <div class="container">
        ...
        <asp:Button ID="btSignISTG" runat="server" Text="Sign in with STG WIFI" 
            CssClass="btn btn-large btn-primary bt" Width="210px"></asp:Button>
        <br /><br />OR<br /><br />
        <asp:Button ID="btSignUp" runat="server" Text="Learn more & Sign Up" PostBackUrl="~/BackEnd/Merchant.aspx"
            CssClass="btn btn-large btn-success btn-large input-medium search-query bt" 
            Width="210px"></asp:Button>
        <br />    <br />    <br />    <br />
