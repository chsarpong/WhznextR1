<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BMovies.aspx.cs" Inherits="stgWifi8.BMovies.BMovies" %>
...
<script>    (function (d, s, id) {
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Movies" CssClass="hh"></asp:Label>
