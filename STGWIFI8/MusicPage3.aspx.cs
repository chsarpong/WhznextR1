...
namespace stgWifi8
{
    public partial class MusicPage3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                populateBigRRadioOnPageLoad();
                populateGetAdsOnPageLoad();
            }
        }
        //Music_GetBigRRadioAndOthers
        private void populateBigRRadioOnPageLoad()
        {
            ...
            int number = 0;
            // Create a DataSet from Database
            com.stgwifiMusic.Music GetBigRRadioOnPageLoad = new com.stgwifiMusic.Music();
            //MusicService.Music musicOnpageLoad = new MusicService.Music();

            DataSet si = GetBigRRadioOnPageLoad.Music_GetBigRRadioAndOthers();
            //DataSet sights = buyer.Buyer_GetAll();
