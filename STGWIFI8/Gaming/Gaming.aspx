<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Gaming.aspx.cs" Inherits="stgWifi8.Gaming.Gaming" %>
  ...
  <div class="btn-group navbar1 navbarclass navbarclassshop">
            ...
            <asp:Button ID="btPostBlog" runat="server" Text="Submit A New Link Now" onclick="btPostBlog_Click" 
             ...
             <%--<asp:Button ID="Button4" runat="server" Text="Start up" PostBackUrl="../StartUp/StartUp.aspx"></asp:Button>--%>
              ...
              <asp:Button ID="Button12" runat="server" Text="Games and Sports" PostBackUrl="../Gaming/Gaming.aspx" CssClass="btn-info btn btn-default"></asp:Button>
              <asp:Button ID="Button2" runat="server" Text="My Blog" CssClass="startb btn btn-default" PostBackUrl="../STGSignIn2.aspx"></asp:Button>
...
<h2 class="location">Games and Sports</h2>
...
<asp:ListItem>Athlectics</asp:ListItem>
<asp:ListItem>Live Video Games Channels </asp:ListItem>
<asp:ListItem>Top Xbox One Channels</asp:ListItem>
<asp:ListItem>Top PS4 Channels</asp:ListItem>
...
<asp:Chart CssClass="chart" ID="Chart1" runat=server DataSourceID="dbf98dac57eafc4c419ea9a33e00945107ConnectionString" Visible="False"><Series>
 ...
 <div class="right">
  <div class="litcss">
  <br />
  <h2 class="sale">Games And Sports</h2>
...
<asp:Panel ID="Panel2" runat="server" GroupingText="" CssClass="paneladShops" Visible="False">
 <a href="http://www.amazon.com/The-Millionaire-Messenger-Difference-Fortune/dp/1451665997?&linkCode=wey&tag=dreamshub-20" class="Adcss btn btn-success">Buy Audio or Paperback Now at Amazon</a>
 <br />
  <%-- <hr />--%>
  <div class="sponsored">
  <div class="bookinfo">
  <br />
  <b> YOU CAN LIGHT THE WAY FOR OTHERS.</b>
  <br /><br />
...
<%--  <br />--%>
   <%--<a href="http://www.amazon.com/The-Millionaire-Messenger-Difference-Fortune/dp/1451665997?tag=dreamshub-20"><img src="../Images/Messenger.jpg" alt="" /></a>--%>
   <hr />  
  <b>Sponsored</b>
