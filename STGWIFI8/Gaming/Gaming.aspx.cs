    ...
    public partial class Gaming : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                ...
                populateGetBestGamesAndSportsOnPageLoadOne();
                populateGetBestGamesAndSportsOnPageLoad();
                populateGetTrendingOnLoad();
                populateGetAdsOnPageLoad();
            }
        }

        //private void populateGetAllGamesAndSportsOnPageLoad()
        //{
        ...
        //    DataSet si = newsonpageload.Product_GetAllGamesandSportsOnPageLoad();
        //    //DataSet sights = buyer.Buyer_GetAll();
        //    s = s + BuildAccordionForGamesAndSports(si, ref number);
        ...
        private void populateGetBestGamesAndSportsOnPageLoad()
        {
        ...
        private void populateGetBestGamesAndSportsOnPageLoadOne()
        {

            string s = "<div id='accordion'> ";
            int number = 0;
            // Create a DataSet from Database
            string productcategory = "Games and Sports";
        ...
        //has a different build compared to others
        protected string BuildAccordionForGamesAndSports(DataSet dataset, ref int number)
        {
            string s = "";
            foreach (DataRow row in dataset.Tables[0].Rows)
            {
                ...
                string body = "<div>" +
                              ...
                              "Comment 1 : " + row["productoptionone"].ToString() + "</p> " + "</p> " +
                              "Comment 2 : " + row["productoptiontwo"].ToString() + "</p> " + "Source : " + row["businessname"].ToString() + "</p> " +
                              "</div>";
        ...
        private void populateGetTrendingOnLoad()
        {
            ...
            DataSet dataset = newsonpageload.Product_GetAllGamesandSportsOnPageLoad();
