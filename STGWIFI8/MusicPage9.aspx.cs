...
namespace stgWifi8
{
    public partial class MusicPage9 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            populateGetZUrbanaOnPageLoad();
            populateGetAdsOnPageLoad();
        }

        private void populateGetZUrbanaOnPageLoad()
        {
            ...
            com.stgwifiMusic.Music GetZUrbanaOnPageLoad = new com.stgwifiMusic.Music();
            //MusicService.Music musicOnpageLoad = new MusicService.Music();

            DataSet si = GetZUrbanaOnPageLoad.Music_GetZUrbanaAndOthers();
            //DataSet sights = buyer.Buyer_GetAll();
