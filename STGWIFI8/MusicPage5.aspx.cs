...
namespace stgWifi8
{
    public partial class MusicPage5 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                populateGetFaraFinaMusicOnPageLoad();
                populateGetAdsOnPageLoad();
            }
        }

        private void populateGetFaraFinaMusicOnPageLoad()
        {
            ...
            com.stgwifiMusic.Music farafina = new com.stgwifiMusic.Music();
            //MusicService.Music musicOnpageLoad = new MusicService.Music();

            DataSet si = farafina.Music_GetFaraFinaAndOthers();
            //DataSet sights = buyer.Buyer_GetAll();
