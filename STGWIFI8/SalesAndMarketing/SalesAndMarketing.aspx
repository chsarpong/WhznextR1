<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesAndMarketing.aspx.cs" Inherits="stgWifi8.SalesAndMarketing.SalesAndMarketing" %>
...
<script>    (function (d, s, id) {
    ...
    <div class="navbar1 navbarclass navbarclassshop">
        <div class="navbar-inner">
            ...
            <asp:Button ID="Button7" runat="server" Text="Motivation" PostBackUrl="../BuildingEffNetwork/BENHome.aspx"></asp:Button>
             ...
             <asp:Button ID="Button8" runat="server" Text="Sales and Marketing" PostBackUrl="../PersonalFinance/Personalfinance.aspx"></asp:Button>
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Sales And Marketing" CssClass="hh"></asp:Label>
