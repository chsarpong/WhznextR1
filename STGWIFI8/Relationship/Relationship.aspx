<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Relationship.aspx.cs" Inherits="stgWifi8.Relationship.Relationship" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="btn-group navbar1 navbarclass navbarclassshop">
            ...
            <asp:Button ID="btPostBlog" runat="server" Text="Submit A New Link Now" onclick="btPostBlog_Click" 
             ...
             <asp:Button ID="Button14" runat="server" Text="Front" 
                    PostBackUrl="../BlogStream.aspx" CssClass="btn btn-default"></asp:Button>
             ...
             <asp:Button ID="Button15" runat="server" Text="Relationships" PostBackUrl="../Relationship/Relationship.aspx" CssClass="btn btn-default btn-info"></asp:Button>
...
<asp:Chart CssClass="chart" ID="Chart1" runat=server DataSourceID="dbf98dac57eafc4c419ea9a33e00945107ConnectionString" Visible="False"><Series>
 ...
 <div class="right">
  <div class="litcss">
  <br />
  <h2 class="sale">All Relationships</h2>
  <asp:Button ID="btPost" runat="server" Text="Post something new" CssClass="post" PostBackUrl="~/BackEnd/Merchant.aspx"></asp:Button>
   <%-- <script type="text/javascript">
        (function () {
...
<div class="nm btn-group" role="group" aria-label="...">
    <asp:Button ID="Button5" runat="server" Text="view more : next" CssClass="glyconnext" 
            PostBackUrl="~/AllChannels.aspx" ToolTip="Search"></asp:Button>
     <asp:Button ID="Button6" runat="server" Text=" 2 " CssClass="glyconnext2" 
            PostBackUrl="~/AllChannels.aspx"></asp:Button>
      <asp:Button ID="Button3" runat="server" Text=" 3 " CssClass="glyconnext2" 
            PostBackUrl="~/AllChannels.aspx"></asp:Button>
      ...
      <asp:Button ID="Button9" runat="server" Text=" 5 " CssClass="glyconnext2" 
       ...
       <asp:Button ID="Button10" runat="server" Text=" 6 " CssClass="glyconnext2" 
            PostBackUrl="~/AllChannels.aspx"></asp:Button>
                   <asp:Button ID="Button4" runat="server" Text=" 7 " CssClass="glyconnext2" 
            PostBackUrl="~/AllChannels.aspx"></asp:Button>
...
<%-- <a href="http://adf.ly/pzv2c" class="Adcss btn btn-success">Buy Kindle or Paperback Now at Amazon</a>--%>
<a href="http://po.st/AmzStudSignUp" class="Adcss btn btn-success">Join Amazon Student FREE Two-Day Shipping</a>
 <br />
  <%-- <hr />--%>
  <div class="sponsored">
  <div class="bookinfo">
  <br />
  <b> THE WOMEN'S HEALTH BOOK OF EXERCISES.</b>
  <br /><br />
  The Women's Health Big Book of Exercises is the essential workout guide for anyone who wants a better body. As the most comprehensive collection of exercises ever created, this makeover manual is a body-shaping power tool for both beginners and longtime fitness buffs alike.
  </div>
  <br />
   <a href="http://adf.ly/pzv2c"><img src="Images/womenshealth.jpg" alt="" /></a>
