<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewsGhana.aspx.cs" Inherits="stgWifi8.NewsGhana" %>
  ...
  <div class="btn-group navbar1 navbarclass navbarclassshop">
            ...
            <asp:Button ID="btPostBlog" runat="server" Text="Submit A New Link Now" onclick="btPostBlog_Click" 
             ...
             <%--<asp:Button ID="Button4" runat="server" Text="Start up" PostBackUrl="../StartUp/StartUp.aspx"></asp:Button>--%>
              <asp:Button ID="Button11" runat="server" Text="Music and Videos" PostBackUrl="../NewsGhana.aspx" CssClass="btn-info btn btn-default"></asp:Button>
              ...
              <asp:Button ID="Button2" runat="server" Text="My Blog" CssClass="startb btn btn-default" PostBackUrl="../MyBlog.aspx"></asp:Button>
              <%--<asp:Button ID="btPostBlog" runat="server" Text="Share a New Link Now" 
                    CssClass="startb btn btn-default" PostBackUrl="../BackEnd/Merchant.aspx"></asp:Button>--%>
...
<h2 class="location">Videos</h2>
<asp:ListBox ID="ListBoxBestCategories" runat="server" CssClass="listboxcities" 
        AutoPostBack="True" Height="150px" Width="320px">
<asp:ListItem>Activism And Non Profits</asp:ListItem>
<asp:ListItem>Animation And Motion Graphics</asp:ListItem>
<asp:ListItem>Art</asp:ListItem>
<asp:ListItem>Education And DIY</asp:ListItem>
<asp:ListItem>Comedy</asp:ListItem>
<asp:ListItem>Everyday Life</asp:ListItem>
<asp:ListItem>Films And Music Videos </asp:ListItem>
</asp:ListBox>
<h2 class="location">What's Trending</h2>
...
<asp:Panel ID="Panel2" runat="server" GroupingText="" CssClass="paneladShops">
 <a href="http://adf.ly/pzuvX" target="_top" class="Adcss btn btn-success">Sign up for video tutorials and more </a>
 <br />
  <%-- <hr />--%>
  <div class="sponsored">
  <div class="bookinfo">
  <br />
  <b> LEARN HOW TO SHOOT GORGEOUS MARKETING VIDEOS</b>
  <br /><br />
  Sign up to get insider tricks that make shooting video SIMPLE even with ZERO video experience and a step-by-step training on Cameras, Audio, Lighting, Editing, Marketing and Monetization
  </div>
  <br />
   <a href="http://adf.ly/pzuvX" target="_top"><img src="http://s3.amazonaws.com/kajabi-media/assets/projects/24422/squeeze_page_thumbnails/33859/large_col/squeeze_still3.png?1399169489" alt="" /></a>
