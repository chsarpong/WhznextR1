<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pics.aspx.cs" Inherits="stgWifi8.Pics.Pics" %>
...
<script>    (function (d, s, id) {
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Pics" CssClass="hh"></asp:Label>
