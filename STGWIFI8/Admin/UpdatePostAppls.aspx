<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdatePostAppls.aspx.cs" Inherits="stgWifi8.Admin.UpdatePostAppls" %>
...
<%--      <a class="navbar-brand" href="#">Channels</a>--%>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
             <asp:Button ID="Button7" runat="server" Text="Sign In" PostBackUrl="../BackEnd/Merchant.aspx" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="Button6" runat="server" Text="New Post" PostBackUrl="../BackEnd/BackendProducts.aspx" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="Button22" runat="server" Text="My Location" PostBackUrl="../BackEnd/MerchantAddress.aspx" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="Button1" runat="server" Text="Product Category" PostBackUrl="../BackEnd/ProductCategory.aspx" CssClass="btnrss btn-default" Enabled="True"></asp:Button>
             <asp:Button ID="Button3" runat="server" Text="View Blog Posts" PostBackUrl="../BackEnd/ViewAllBlogs.aspx" CssClass="btnrss btn-default" Enabled="True"></asp:Button>
             <asp:Button ID="Button5" runat="server" Text="Back to Admin All Applications" PostBackUrl="../Admin/PostApplications.aspx" CssClass="btnrss btn-default" Enabled="True"></asp:Button>
       ...
       <ul class="nav navbar-nav navbar-right">
          <li >
          <a class="navbar-brandrss" href="../BackEnd/BackendProducts.aspx"><asp:Label ID="Label16" runat="server" Text="Login"></asp:Label></a>
        </li>
       </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
...
<br />
<asp:Label ID="lbSessionWriteAblog" runat="server" Text="" Font-Size="XX-Large"></asp:Label>
<hr />
<%--<br />--%>
<div>
...
<br />
<asp:TextBox ID="tbProductId" runat="server" CssClass="Position" Enabled="False"></asp:TextBox>
<br />
...
<br />
<asp:TextBox ID="tbPrice" runat="server" CssClass="Position"></asp:TextBox>
<br />
<asp:Label ID="Label6" runat="server" Text="Quantity"></asp:Label>
<br />
<asp:TextBox ID="tbQuantity" runat="server" CssClass="Position"></asp:TextBox>
<br />
<asp:Label ID="Label9" runat="server" Text="Video/Image Iframe"></asp:Label>
<br />
<asp:TextBox ID="tbVideoImage" runat="server" CssClass="Position"></asp:TextBox>
<br />
</div>
...
<br />
<asp:Label ID="Label13" runat="server" Text="Summary 4(optional)"></asp:Label>
<br />
<asp:TextBox ID="tbProductOption4" runat="server" CssClass="Position" TextMode="MultiLine" Width="500px" Height="150px"></asp:TextBox>
<br />
<asp:Label ID="Label14" runat="server" Text="Summary 5(optional)"></asp:Label>
<br />
<asp:TextBox ID="tbProductOption5" runat="server" CssClass="Position" TextMode="MultiLine" Width="500px" Height="150px"></asp:TextBox>
<br />
<asp:Label ID="lbSessionbn" runat="server" Visible="False"></asp:Label>
...
<asp:Button ID="btAddProducts" runat="server" Text="Publish" 
        onclick="btAddProducts_Click"></asp:Button>
<asp:Button ID="btUpdateProduct" runat="server" Text="Update" onclick="btUpdateProduct_Click"></asp:Button>
<asp:Button ID="btDeleteProduct" runat="server" Text="Delete"></asp:Button>
<asp:Button ID="btReset" runat="server" Text="Reset" onclick="btReset_Click"></asp:Button>
</div>
<br /><br />
    <a href="../Admin/PostApplications.aspx">Post Applications</a>
</div>
<br /><br />
<div class="">
 <br />
