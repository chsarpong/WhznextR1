<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignIn2.aspx.cs" Inherits="stgWifi8.Admin.AdminSignIn2" %>
...
<div class="container2">
    <div class="container">
        ...
        <asp:Button ID="btSignUp" runat="server" Text="Learn more & Sign Up" 
            ...
            Width="210px" PostBackUrl="~/Sponsor.aspx"></asp:Button>
        <br />    <br />    <br />    <br />
        <br />
