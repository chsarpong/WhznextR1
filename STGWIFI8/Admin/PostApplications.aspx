<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostApplications.aspx.cs" Inherits="stgWifi8.Admin.PostApplications" %>
...
<%--             <asp:Button ID="Button1" runat="server" Text="Product Category" PostBackUrl="../BackEnd/ProductCategory.aspx" CssClass="btn btn-default" Enabled="False"></asp:Button>--%>
             ...
             <%--<asp:Button ID="Button4" runat="server" Text="Start up" PostBackUrl="../StartUp/StartUp.aspx"></asp:Button>--%>
              ...
              <asp:Button ID="btAllBloggers" runat="server" Text="All Bloggers" 
                    CssClass="btnrss btn-default startb" PostBackUrl="../Admin/Allbloggers.aspx"></asp:Button>
             <asp:Button ID="btAllBlogPost" runat="server" Text="All Blog Posts" 
                    CssClass="btnrss btn-default" Enabled="True" 
                    onclick="btAllBlogPost_Click"></asp:Button>
...
<%--            <asp:TextBox ID="tbSeatch" CssClass="txtboxSearch" 
                ...
                <asp:Label ID="Label1" runat="server" Text="Admin: select to update" Width="834px" Height="17px" ForeColor="Blue" Font-Size="Larger"></asp:Label>

            <asp:TextBox ID="tbsearch" runat="server" CssClass="tbsearch" Width="700px"></asp:TextBox>
       <%--     <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True">
            ...
            <asp:Button ID="btSearch" runat="server" Text="Search customer " Height="26px"  CssClass="txtboxSearch"
                Width="146px" onclick="btSearch_Click"></asp:Button></li>
      </ul>

    <br /><br />
        <asp:Label ID="lbSessionFromGridpid" runat="server" Text="Label"></asp:Label>
    
    <asp:Label ID="lbSearchError" runat="server" Text="Label"></asp:Label>
...
<%--              <asp:TemplateField HeaderText="Sites" ShowHeader="False" ControlStyle-CssClass="btn btn-primary btn-mini" ControlStyle-Width="80px">
      ...
      <asp:GridView ID="GridViewBloggers" runat="server">
        </asp:GridView>
      <br />
