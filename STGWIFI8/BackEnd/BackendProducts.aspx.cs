...
{
    public partial class BackendProducts : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                ...
                if (Session["Publish a new blog post"] != null)
                    lbSessionWriteAblog.Text = Session["Publish a new blog post"].ToString();
        ...
        private void populateddlSellingLead()
        {
            ...
            foreach (DataRow dr in dataset.Tables[0].Rows)
            {
                string s = dr["sellinglead"].ToString();
                ListItem listItem = new ListItem();
                listItem.Text = s;
        ...
        protected void btAddProducts_Click(object sender, EventArgs e)
        {
            ...
            if (successfull)
            {
                ...
                //btAddProducts.Attributes.Add("onclick", "return confirm('Link submitted successfully!')");
                Response.Redirect("../PostSuccessful.aspx");
            }
            else
            {
                lbError.Text = "Please select channel you are publishing to ";
            }
        }
        ...
        protected void ddlProdCategoryId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lbError.Text = "You are creating something new - Great!! - By pusblishing 100 great post you can upgrade, personalize and monetize your blog as business";
