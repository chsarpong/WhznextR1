<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Social-Vote.aspx.cs" Inherits="stgWifi8.BackEnd.Social_Vote" %>
...
<%--             <asp:Button ID="Button1" runat="server" Text="Product Category" PostBackUrl="../BackEnd/ProductCategory.aspx" CssClass="btn btn-default" Enabled="False"></asp:Button>--%>
             <asp:Button ID="Button1" runat="server" Text="My Votes" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="btSubmitted" runat="server" Text="Submitted" 
                    CssClass=" btnrss btn-default" onclick="btSubmitted_Click"></asp:Button>
       ...
       <ul class="nav navbar-nav navbar-right">
          <li >
          <a class="navbar-brandrss" href="../BackEnd/BackendProducts.aspx"><asp:Label ID="lbSessionbn" runat="server" Text="Log In" Height="15px" ForeColor="#3a5795" Font-Size="Large" CssClass=""></asp:Label></a>
        </li>
       </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
...
<%--            <asp:TextBox ID="tbSeatch" CssClass="txtboxSearch" 
            ...
            <asp:Label ID="Label1" runat="server" Text="Select to start voting" Width="1197px" CssClass="btn-primary" Height="17px" Font-Size="Larger"></asp:Label>
...
<div class="">
   <asp:GridView ID="GridViewShop" runat="server" CssClass="stock" CellPadding="4" 
    ...
    <br />
      ...
      <asp:GridView ID="GridViewViewSocialVote" runat="server" ForeColor="#333333"
        CssClass="top table table-striped table-bordered table-condensed" AllowPaging="True" 
        AllowSorting="True" PageSize="200" DataKeyNames="productid" 
        onselectedindexchanged="GridViewViewSocialVote_SelectedIndexChanged">
      </asp:GridView>
      <br />
