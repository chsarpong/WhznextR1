<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vote.aspx.cs" Inherits="stgWifi8.BackEnd.Vote" %>
...
<%--             <asp:Button ID="Button1" runat="server" Text="Product Category" PostBackUrl="../BackEnd/ProductCategory.aspx" CssClass="btn btn-default" Enabled="False"></asp:Button>--%>
             <asp:Button ID="Button1" runat="server" Text="Up Vote | Down Vote" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="Button22" runat="server" Text="Submitted" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="ButtonRF" runat="server" Text="Rising Front" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="BtMotivation" runat="server" Text="Motivation" CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="BtRelationship" runat="server" Text="Relationships" 
                    CssClass="btnrss btn-default"></asp:Button>
             <asp:Button ID="BtFitnessAndNutrition" runat="server" Text="Fitness|Nutrition" 
                    CssClass="btnrss btn-default" ></asp:Button>
             <%--<asp:Button ID="Button4" runat="server" Text="Start up" PostBackUrl="../StartUp/StartUp.aspx"></asp:Button>--%>
              <asp:Button ID="BtVideos" runat="server" Text="Videos" CssClass="btnrss btn-default"></asp:Button>
              <asp:Button ID="BtGamesAndSports" runat="server" Text="Games|Sports" 
                    CssClass="btnrss btn-default"></asp:Button>
             
             <asp:Button ID="btViewAllBlogs" runat="server" Text="All" 
                    CssClass="btnrss btn-default" Enabled="True"></asp:Button>
...
<%--            <asp:TextBox ID="tbSeatch" CssClass="txtboxSearch" 
            ...
            <asp:Label ID="Label1" runat="server" Text="Start voting" Height="17px" Width="1197px" CssClass="btn-primary" Font-Size="Larger"></asp:Label>
...
<div class="">
   <asp:GridView ID="GridViewShop" runat="server" CssClass="stock" CellPadding="4" 
    ...
    <br />
      ...
      <asp:Button ID="btNewLink" runat="server" Text="Up Vote" 
        class="btn btn-success" ></asp:Button>
      <asp:Button ID="Button3" runat="server" Text="Down Vote" 
        class="btn btn-primary" ></asp:Button>
      <asp:Button ID="Button4" runat="server" Text="Visit Site Before" 
        class="btn btn-info"></asp:Button>

    <br />
       <asp:GridView ID="GridViewViewVote" runat="server"  CssClass="top table table-striped table-bordered table-condensed"
      CellPadding="4" 
...
<%--              <asp:HyperLinkField HeaderText="Action" ControlStyle-CssClass="btn btn-primary btn-mini" NavigateUrl="~/BackEnd/UpdateBlog.aspx" Text="Update" />--%>
      ...
      <br />
      <br /><br />
    <asp:Label ID="Label2" runat="server" Text="24" CssClass="label label-default votenumb"></asp:Label>
    <br /><br />
    <asp:Label ID="lbSessionFromGridpid" runat="server" Text="There doesn't seem to be anything like your vote here"></asp:Label>
    <asp:Label ID="lbError" runat="server" ForeColor="White" BackColor="#009900" Font-Size="Larger"></asp:Label>       
