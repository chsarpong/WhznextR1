<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FitnessAndNutrition.aspx.cs" Inherits="stgWifi8.FitnessAndNutrition.FitnessAndNutrition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="btn-group navbar1 navbarclass navbarclassshop">
            ...
            <asp:Button ID="btPostBlog" runat="server" Text="Submit A New Link Now" 
                    CssClass="btn btn-success startb btn-default2" Width="190px" OnClick="btPostBlog_Click"></asp:Button>
             ...
             <asp:Button ID="Button16" runat="server" Text="Fitness and Nutrition" PostBackUrl="../FitnessAndNutrition/FitnessAndNutrition.aspx" CssClass="btn btn-default btn-info"></asp:Button>
...
<h2 class="location">Fitness And Nutrition</h2>
<asp:ListBox ID="ListBoxBestCategories" runat="server" CssClass="listboxcities" 
        AutoPostBack="True" Height="150px" Width="320px">
<asp:ListItem>Bodyweight Burners</asp:ListItem>
<asp:ListItem>Muscle Training Manual</asp:ListItem>
<asp:ListItem>Training Plans</asp:ListItem>
<asp:ListItem>Core Strength</asp:ListItem>
<asp:ListItem>Best Foods</asp:ListItem>
<asp:ListItem>Workout Videos</asp:ListItem>
</asp:ListBox>
...
<br />
<h3 class="">Remember to subcribe</h3>
...
<asp:Chart CssClass="chart" ID="Chart1" runat=server DataSourceID="dbf98dac57eafc4c419ea9a33e00945107ConnectionString" Visible="False"><Series>
 ...
 <div class="right">
  <div class="litcss">
  <br />
  <h2 class="sale">All Fit and Nutritious</h2>
  <asp:Button ID="btPost" runat="server" Text="Post new link" CssClass="post" PostBackUrl="~/BackEnd/Merchant.aspx"></asp:Button>
    <%--<script type="text/javascript">
        (function () {
...
<asp:Panel ID="Panel2" runat="server" GroupingText="" CssClass="paneladShops">
 <br />
  ...
  <br />
  <a href="http://www.youtube.com/watch?v=CPpMeRCG1WQ&list=PLHFlHpPjgk73J6C3PHUrDntzy6TQxBh44&index=3" class="Adcss btn btn-success">Watch intro video</a>
  <br /><br />
   <a href="http://www.youtube.com/watch?v=ktujsc4ZUTo&list=PLHFlHpPjgk73J6C3PHUrDntzy6TQxBh44"><img src="http://images.apple.com/watch/home/images/watch_tab_primary_large.jpg" alt="" /></a>
