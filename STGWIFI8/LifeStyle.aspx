<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LifeStyle.aspx.cs" Inherits="stgWifi8.LifeStyle" %>
...
<%--                 <li><a href="../NewsGhana.aspx">Ghana</a></li>
                 <li ><a href="../News.aspx">Science/Technology</a></li>
                <li><a href="../NewsSports.aspx">Sports</a></li>--%>
                <li class="active"><a href="Documentation/STGWireless%20Business%20Model%20Canvas_SN_v0%201%20-%20Charles-n.odt">Download Whznext and STG Wireless Business Model</a></li>
...
<%--    <div class="navbar1 navbarclass navbarclassshop">
        <div class="navbar-inner">
            <ul class="nav nav-pills marleft">
                <li><a href="../News.aspx">Fashion</a></li>
                 <li ><a href="../NewsGhana.aspx">Weight Management</a></li>
                <li><a href="../NewsAfrica.aspx">Health</a></li>
                <li><a href="../NewsSports.aspx">Sex</a></li>
            </ul>
        </div>
    </div>--%>
