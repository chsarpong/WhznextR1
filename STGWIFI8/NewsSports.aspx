<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewsSports.aspx.cs" Inherits="stgWifi8.NewsSports" %>
    ...
    <div class="navbar1 navbarclass navbarclassshop">
        <div class="navbar-inner">
            <ul class="nav nav-pills marleft">
                ...
                <li class="active"><a href="../NewsSports.aspx">Sports</a></li>
 ...
 <div class="heading">
   ...
   <hr />
     ...
     <div class="featurette">
        <img class="featurette-image pull-left" src="Images/_71148311_ronaldo464.jpg" alt=""/>
        <h2 class="featurette-heading"> International football <span class="muted"></span></h2>
