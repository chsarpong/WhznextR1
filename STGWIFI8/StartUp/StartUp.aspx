<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StartUp.aspx.cs" Inherits="stgWifi8.StartUp.StartUp" %>
...
<script>    (function (d, s, id) {
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Start Up" CssClass="hh"></asp:Label>
