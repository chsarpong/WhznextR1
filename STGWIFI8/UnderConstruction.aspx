<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnderConstruction.aspx.cs" Inherits="stgWifi8.UnderConstruction" %>
...
<asp:Panel ID="Panel1" runat="server" CssClass="panel1home" 
         BorderColor="Silver">
         <br /><br /><br /><br />
        <h2 class="featurette-heading">Oops we were confused. Try Again <span class="muted"></span></h2>      
