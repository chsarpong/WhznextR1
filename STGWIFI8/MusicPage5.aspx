<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage5.aspx.cs" Inherits="stgWifi8.MusicPage5" %>
...
<%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Fara Fina Radio" CssClass="lbradio"></asp:Label>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
