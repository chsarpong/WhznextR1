<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Page1.aspx.cs" Inherits="stgWifi8.GhanaNews.Page1" %>
...
<asp:Button ID="Button3" runat="server" Text="Back to Ghana News" Width="200px" Height="35px"
        onclick="Button3_Click" />
</div>
    
<div class="Stone1">
<%--<img src="../Images/_72116625_vortex1.jpg"  alt="" class="imgPage1"/>--%>
<iframe width="600" height="360" src="//www.youtube.com/embed/zDUuCxG8i0g?feature=player_detailpage" frameborder="0" allowfullscreen class="href"></iframe>
<br /><br />
 <p class="lead">From Montana to Maryland, about half of the US population has been placed under a wind chill warning or advisory.</p>
  <p class="lead">In Canada, the province of Ontario is facing temperatures of -40C (-40F) with wind chill.</p>
   <p class="lead">Thousands of flights have been grounded, and residents told their skin could freeze if they go outside</p>
 <p class="lead">Temperatures were set to plummet overnight in New York and Washington DC by as much as 45 degrees, from unseasonably clement highs a day earlier.</p>
  <p class="lead">New York Governor Andrew Cuomo announced that parts of major highways would be closed in preparation for the extreme weather, which could see the mercury plummet to -26C (15F) overnight with wind chill.</p>
   <p class="lead">The weather has been blamed for at least 16 deaths in recent days.</p>
