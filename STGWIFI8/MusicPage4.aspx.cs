...
namespace stgWifi8
{
    public partial class MusicPage4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                populateGetBigROnPageLoad();
            }
        }


        private void populateGetBigROnPageLoad()
        {
            ...
            com.stgwifiMusic.Music bigR = new com.stgwifiMusic.Music();
            //MusicService.Music musicOnpageLoad = new MusicService.Music();

            DataSet si = bigR.Music_GetBigRRadioAndOthers(); ;
            //DataSet sights = buyer.Buyer_GetAll();
