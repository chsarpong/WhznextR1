<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="register-merchant-account.aspx.cs" Inherits="stgWifi8.business_community.register_merchant_account" %>
...
<br />
<asp:Label ID="Label3" runat="server" Text="We will contact with sign in" Font-Size="XX-Large"></asp:Label>
<br /><br />
<div class="inners">
...
<br /><br />
<asp:Button ID="btAnonymous" runat="server" Text="Take A Walk Through" 
...
<asp:Label ID="lbSessionRegisterBlog" runat="server" 
        Text="We will contact you to register" Font-Size="XX-Large"></asp:Label>
<br /><br />
...
<br /><br /><br />
<div class="inputs">
<asp:Label ID="lbBusinessName" runat="server" Text="Name Of Your Business"></asp:Label>
<br />
