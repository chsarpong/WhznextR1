...
{
    public partial class register_merchant_account : System.Web.UI.Page
    {
        ...
        protected void btSinInMer_Click1(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dataset.Tables[0].Rows)
            {
                ...
                if (successfull)
                {
                    ...
                    //have to fix
                    Response.Redirect("register-merchant-account.aspx");
        ...
        {    
            ...
            Response.Redirect("promote-offer.aspx");
            //Have to fix
            ...
            //        Response.Redirect("business-community");
            //        //Response.Redirect("http://login.stgwifi.com/login");
