<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage4.aspx.cs" Inherits="stgWifi8.MusicPage4" %>
...
<%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Big R Radio changes 5 and 6" CssClass="lbradio"></asp:Label>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
