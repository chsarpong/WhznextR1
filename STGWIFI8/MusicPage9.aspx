<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage9.aspx.cs" Inherits="stgWifi8.MusicPage9" %>
...
<%--                <img src="Images/searchicon.png" alt="" />--%>
    ...
    <%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Z-Urbana" CssClass="lbradio"></asp:Label>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
