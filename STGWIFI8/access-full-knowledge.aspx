<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="access-full-knowledge.aspx.cs" Inherits="stgWifi8.access_full_knowledge" %>
...
<%--<img src="Images/topic_iphone_4s.png" alt="" />--%>
     <p class="featurette-heading1 small1">Subscribe to interesting content and information submitted by experts in our community.</p>
     <p class="featurette-heading1 small1">Buy products and programs with customer rating and pay later.</p>
     <p class="featurette-heading1 small1">Create an account and enjoy the benefits.</p><br />
...
<%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" 
  ...
  <div class="nanolo">
  <br />
  <img src="../Images/newss.png"  alt="" width="500px" height="250px" class="innerimg"/>
<%--   <br />
