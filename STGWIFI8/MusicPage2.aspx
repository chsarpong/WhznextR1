<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage2.aspx.cs" Inherits="stgWifi8.MusicPage2" %>
...
<%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Polskastacja Radio" CssClass="lbradio"></asp:Label>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
