<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Personalfinance.aspx.cs" Inherits="stgWifi8.PersonalFinance.Personalfinance" %>
...
<script>    (function (d, s, id) {
 ...
 <div class="heading">
   <%--<h1 class="hh">Blog </h1>--%>
   <asp:Label ID="Label1" runat="server" Text="Personal Finance" CssClass="hh"></asp:Label>
