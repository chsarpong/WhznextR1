...
namespace stgWifi8.BuildingEffNetwork
{
    public partial class BENHome : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Change needed
                //populateGetAllMotivationOnPageLoad();
        ...
        //private void populateGetAllMotivationOnPageLoad()
        //{
        ...
        //    DataSet si = newsonpageload.Product_GetAllMotivationOnPageLoad();
        //    //DataSet sights = buyer.Buyer_GetAll();
        //    s = s + BuildAccordionForMotivation(si, ref number);
        ...
        protected string BuildAccordionForMotivation(DataSet dataset, ref int number)
        {
            string s = "";
        ...
        private void populateGetTrendingOnLoad()
        {
            ...
            DataSet dataset = newsonpageload.Product_GetAllMotivationOnPageLoad();
