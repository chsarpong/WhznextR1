...
namespace stgWifi8
{
    public partial class MusicPage8 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            populateGetTheBox181FMOnPageLoad();
            populateGetAdsOnPageLoad();
        }

        private void populateGetTheBox181FMOnPageLoad()
        {
            ...
            int number = 0;
            // Create a DataSet from Database
            com.stgwifiMusic.Music GetTheBox181FMOnPageLoad = new com.stgwifiMusic.Music();
            //MusicService.Music musicOnpageLoad = new MusicService.Music();

            DataSet si = GetTheBox181FMOnPageLoad.Music_GetTheBox181FMAndOthers();
            //DataSet sights = buyer.Buyer_GetAll();
