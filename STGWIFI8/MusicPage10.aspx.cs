...
namespace stgWifi8
{
    public partial class MusicPage10 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            populateMangoUrbanOnPageLoad();
            populateGetAdsOnPageLoad();
        }

        private void populateMangoUrbanOnPageLoad()
        {
            ...
            int number = 0;
            // Create a DataSet from Database
            com.stgwifiMusic.Music GetMangoUrbanOnPageLoad = new com.stgwifiMusic.Music();
            //MusicService.Music musicOnpageLoad = new MusicService.Music();

            DataSet si = GetMangoUrbanOnPageLoad.Music_GetZUrbanaAndOthers();
            //DataSet sights = buyer.Buyer_GetAll();
