<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage6.aspx.cs" Inherits="stgWifi8.MusicPage6" %>
...
<%--                <img src="Images/searchicon.png" alt="" />--%>
               <asp:Button ID="Button1" runat="server" Text="Search" CssClass="searchbox" BackColor="White" 
                      Width="157px"></asp:Button>
...
<div class="video">
  ...
  <asp:Button ID="Button3" runat="server" Text="Go To Playlist" CssClass="Playlist btn-primary" 
                                 ForeColor="White" onclick="Button3_Click"></asp:Button>
      <img src="Images/disco-party.jpg" alt="" class="nn" />
