<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MusicPage10.aspx.cs" Inherits="stgWifi8.MusicPage10" %>
...
<%--                <img src="Images/searchicon.png" alt="" />--%>
    ...
    <%-- Image--%>
<div class="video">
     <asp:Label ID="Label4" runat="server" Text="Mango Urban" CssClass="lbradio"></asp:Label>
  </div>
 <%-- literal accordion--%>
  <div class="toright">
